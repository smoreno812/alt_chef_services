...
cd $INSTALL_DIR/chef_installer
 curl -o $INSTALL_DIR/chef_installer/cookbooks/installer/recipes/installer.rb https://raw.githubusercontent.com/smorneo812/csg_chef_services/master/files/default/installer.rb
