...
chef-client -z -j attributes.json --config-option file_cache_path=$INSTALL_DIR -r 'recipe[csg_manage_server]' --recipe-url http://artifactory.csgicorp.com/artifactory/csg-17.1.0-artifacts/com.csgi/ChefFramework/I/17.1.0.0.0/17.1.0.0.0-152/csg_manage_server.tar.gz
